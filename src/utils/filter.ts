 ...
 * @returns An array of OperandExpressions to be evaluated by the caller.
 */
function processFilterWithTag<DB = unknown, TB extends keyof DB = keyof DB>(
  table: TB,
  tagsTable: TB,
  eb: ExpressionBuilder<DB, TB>,
  filter: Filter,
